        ...
        <section className={`${styles.wrapper}`}>
            <div className={`${styles.content}`}>
                ...
                <ul className={`${styles['info-wrapper']}`}>
                    ...
                    <li className={`${styles.info}`}>
                        <i class="fa-solid fa-dollar-sign"></i> <span className={`${styles['li-content']}`}>Price: {attraction?.price}</span>
                    </li>
                    <li className={`${styles.info}`}>
                ...
                <ul className={`${styles.btns}`}>
                    <li className={`${styles['btn-addPlan']}`}>
                        <button className="btn btn-success"><i class="fa fa-bus"></i>Add to plan</button>
                    </li>
                    <li className={`${styles['btn-edit']}`}>
                        <button className="btn btn-outline-dark"><i class="fa-solid fa-pen"></i>Edit</button>
                    </li>
                    <li className={`${styles['btn-edit']}`}>
                        <button className='btn btn-outline-danger'><i class="fa-solid fa-trash"></i>Delete</button>
                    </li>
                </ul>
            </div>
