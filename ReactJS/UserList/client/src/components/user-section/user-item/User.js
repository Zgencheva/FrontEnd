...
export const User = ({
   ...
   onActionClick
    ...
    return (
        <>
            <td>
                <img src={user.imageUrl || blankProfilUrl}
                    alt={`${user.firstName}'s profiler`} className="image" />
            </td>
            ...
            <td className="actions">
                ...
                <button className="btn info-btn" title="Info" onClick={()=> onActionClick(user._id, UserActions.Info)}>
