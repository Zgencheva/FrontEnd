...
export const UserAddorEdit = ({
    ...
    const submitHandler = (e) => {
        ...
        user == null ? onCreate(userData) : onEdit(userData);
    };
            ...
            <div className="modal">
                <div className="user-container">
                    <header className="headers">
                        {user == null && <h2>Add User</h2>}
                        {user != null && <h2>Edit User</h2>}
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <div id="form-actions">
                            {user == null &&
                                <button id="action-save" className="btn" type="submit" disabled={Object.values(errors).some(er => er.isValid) || !touched}>Save</button>
                            }
                            {user != null &&
                                <button id="action-save" className="btn" type="submit" disabled={Object.values(errors).some(er => er.isInvalid)}>Save</button>
                            }
